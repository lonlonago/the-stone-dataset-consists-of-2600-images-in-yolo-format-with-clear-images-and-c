# The stone dataset consists of 2600 images in YOLO format with clear images and complete annotations.

# Body

The stone dataset consists of 2600 images in YOLO format, with clear images and complete annotations. It is suitable for scenarios such as road obstructions, geological disasters, traffic detection, etc., and can be directly used, saving time and effort
